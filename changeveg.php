...
<body>
<form action="changevegprocess.php" method="POST">
Roti Type:<br/>
...
<option value="cauliflower">chilly cauliflower</option> 
         ...
         <div align="center" style="margin-top:10px">
                 ...
                 <form action="changevegprocess.php" method="POST">
				     ...
				     <select name="main1"  class="step1" required>  
							<option selected="" value="">(Please select type)</option>  
							<option value="paneer">paneer</option>  
							<option value="chilly cauliflower">chilly cauliflower</option> 
							<option value="mushroom">mushroom</option> 
					 </select><br><br>
				      <h2 style="color:#e22b28;"class="btnpad">SELECT SIDE ITEM</h2>
