...
{ 
	if(isset($_POST['username'])&&!empty($_POST['username']))
	{
		...
		if($result=mysql_query($query))
		{
			...
			if($rows==0)
			{
				 $_SESSION['error2']="nousername";
				 header('Location: viewusername.php');
			}
			else
			{
				?>
...
<html >
     <head>
         ...
         <title>View UsernameRecord</title>
         <meta charset="utf-8">
	 ...
	 <body>
         ...
         <div align="center" style="margin-top:30px">
		      <h2 style="color:#e22b28;"class="btnpad"><b>DETAILS FOR <?=$username;?> ARE</b></h2><br>
               <strong> <br></strong>
				<table style="text-align:center" border="2" bordercolorlight="#A0A0A4">
