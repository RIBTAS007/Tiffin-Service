...
{	
	...
	<body>
	<form action="changestatusprocess2.php" method="POST">
	ref id:<br>
	<input type="number" name="refid" value=<?=$refid;?> style="display:none">
...
<html >
	 ...
	 <body>
         ...
         <div align="center" style="margin-top:100px">
		      <h2 style="color:#e22b28;"class="btnpad"><b>SELECT STATUS TYPE</b></h2><br>
