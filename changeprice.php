...
<body>
<form action="changepriceprocess.php" method="POST">
	 ...
	 <body>
			 ...
			 <div class="container-fluid">
				 ...
				 <div class="collapse navbar-collapse" id="mainNavBar"  role="navigation">
					<ul class="nav navbar-nav navbar-right">
						 ...
						 <li><a href="#" ><span class="glyphicon glyphicon-list-alt">ChangePrice</a></li>
		 ...
		 <div id="mySidenav" class="sidenav ">
		     ...
		     <ul style="list-style: none;">
				 ...
				 <li><a href="#" onclick="closeNav()"><span class="glyphicon glyphicon-list-alt">ChangePrice</a></li>
		 ...
		 <h2 style="color:#e22b28;"class="btnpad">CHANGE BILL AMOUNT</h2></br>
