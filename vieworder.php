...
<body>
<form action="vieworderprocess.php" method="POST">
<input type="date" name="date"><br>
<select name="foodtime"  required>  
	 ...
	 <body>
			 ...
			 <div class="container-fluid">
				 ...
				 <div class="collapse navbar-collapse" id="mainNavBar"  role="navigation">
					<ul class="nav navbar-nav navbar-right">
						 ...
						 <li><a href="#" ><span class="glyphicon glyphicon-list-alt">ViewOrder</a></li>
		 ...
		 <div id="mySidenav" class="sidenav ">
		     ...
		     <ul style="list-style: none;">
			     ...
			     <li><a href="#" onclick="closeNav()"><span class="glyphicon glyphicon-list-alt">ViewOrder</a></li>
		 ...
		 <h2 style="color:#e22b28;"class="btnpad">VIEW ORDER</h2></br>
		  <div align="center" style="margin-top:10px">
             
        
             <form action="vieworderprocess.php" method="POST">
			     <h2 style="color:#e22b28;"class="btnpad">SELECT DATE :</h2></br>
                 <input type="date" name="date" class="step1"><br><br>
				 <h2 style="color:#e22b28;"class="btnpad">SELECT MENU :</h2></br>
				 <select name="foodtime" class="step1" required>  
				     <option selected="" value="">(Please select type)</option>  
					 <option value="dinner">dinner</option>  
					 <option value="lunch">lunch</option> 
				</select><br><br>
				<h2 style="color:#e22b28;"class="btnpad">SELECT STATUS :</h2></br>
				<select name="status" class="step1" required>  
					 <option selected="" value="">(Please select type)</option>  
					 <option value="undelivered">undelivered</option>  
					 <option value="delivered">delivered</option> 
				</select>
...
<?php
		if(isset($_SESSION['error'])&&!empty($_SESSION['error']))
			...
			{
				echo"<script type='text/javascript'>alert('No such order exists');</script>";
				$_SESSION['error2']="";
			}
