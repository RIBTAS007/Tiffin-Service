	 ...
	 <body>
			 ...
			 <div class="container-fluid">
				 ...
				 <div class="collapse navbar-collapse" id="mainNavBar"  role="navigation">
					<ul class="nav navbar-nav navbar-right">
						 <li><a href="#" ><i class="fa fa-home" aria-hidden="true"></i> <b>OrderDetails</b></a></li>
		 ...
		 <div id="mySidenav" class="sidenav ">
		     ...
		     <ul style="list-style: none;">
		         <li><a href="#" onclick="closeNav()"><i class="fa fa-home" aria-hidden="true" ></i><b>OrderDetails</b></a></li>
		 ...
		 <script src="js/index.js"></script>
		  ...
		  <h1 style="color:#e22b28;"class="btnpad"><b> ORDER DETAILS FOR <?php echo "$username"; ?></b></h1>
